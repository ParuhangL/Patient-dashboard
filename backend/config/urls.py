...
from patients.admin_views import AdminLoginView
from patients.admin_views import AdminLoginView, AdminStatsView
from patients.admin_views import AdminLoginView, AdminStatsView, AdminUserListView
